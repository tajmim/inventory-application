    ...
    <div class="login-userset">
        ...
        <form action="{{ route('register') }}" method="POST" class="form-login">
            ...
            <div class="form-login">
                ...
                <div class="pass-group">
                    <input type="password" class="pass-input" placeholder="Re-enter your password" name="confirm_password" required>
                    <span class="fas toggle-password fa-eye-slash"></span>
                </div>
            </div>
        ...
        <div class="signinform text-center">
            <h4>Already a user? <a href="{{ route('home') }}" class="hover-a">Sign In</a></h4>
        </div>
